...
def run_caps(model, processor, args):
    ...
    caps_root = os.path.join(args.output_dir, "vizwiz_caps_data")
...
def main():
    ...
    parser.add_argument("--vizwiz_val_json", default="outputs/predictions/vizwiz_caps_data/annotations/val.json",
