...
Usage
-----
export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True   # set the variable
OR
import os
os.environ["PYTORCH_CUDA_ALLOC_CONF"] = "expandable_segments:True"
# This MUST run BEFORE you import torch or touch the GPU — ideally the very first cell.
